package com.example.payment_service.infrastructure.logging;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.example.payment_service.application.service..*.*(..))")
    public void servicePackagePointcut() {}

    @Pointcut("execution(* com.example.payment_service.api.exception_handler.GlobalExceptionHandler.*(..))")
